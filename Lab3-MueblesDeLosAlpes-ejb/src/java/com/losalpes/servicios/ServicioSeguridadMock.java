/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ $Id$
 * ServicioSeguridadMock.java Universidad de los Andes (Bogotá - Colombia)
...
public class ServicioSeguridadMock implements IServicioSeguridadMockLocal {
     ...
     * @param contrasenia Contraseña del usuario que quiere ingresar al sistema.
     * @return usuario Retorna el objeto que contiene la información del usuario
     * que ingreso al sistema.
     */
    @Override
    public Usuario ingresar(String nombre, String contrasenia) throws AutenticacionException {
        Usuario u = (Usuario) persistencia.findById(Usuario.class, nombre);

        if (u != null) {
            if (u.getLogin().equals(nombre) && u.getContrasenia().equals(contrasenia)) {
                return u;
            } else {
