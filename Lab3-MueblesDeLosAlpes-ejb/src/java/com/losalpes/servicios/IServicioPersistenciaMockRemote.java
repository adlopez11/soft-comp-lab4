/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ $Id$
 * IServicioPersistenciaMockRemote.java Universidad de los Andes (Bogotá -
...
public interface IServicioPersistenciaMockRemote {
    ...
    /**
     * Devuelve una lista con de todos los elementos de una clase dada que se
    ...
    /**
     * Retorna una consulta especifica
     */
    public List findQuery(String namedQuery);
